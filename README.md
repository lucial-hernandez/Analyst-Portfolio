...
### Data
The analysis uses the Transitional Justice Evaluation Tools (TJET) dataset, which measures comparative data on transitional justice mechanisms across countries. The replication data file is included in this repository. Find the dataset at https://transitionaljusticedata.org/en/
